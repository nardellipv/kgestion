...
@section('content')
    <div class="p-20">
        {!! Form::open(['method' => 'POST','route' => ['photo.add'],'style'=>'form-horizontal','enctype' => 'multipart/form-data']) !!}
        {{ csrf_field() }}
        ...
        <button type="submit" class="btn btn-block btn-xs btn-purple waves-effect waves-light">Subir Imagen</button>
        {!! Form::Close() !!}
    </div>
@endsection
