...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b'], ['Series A', 'Series B'],['0.1'],['#ffffff'],['#999999'], ['#35b8e0', '#5b69bc']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#10c469', '#5b69bc', "#35b8e0"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#10c469', '#5b69bc', "#35b8e0"]);
    },
    //init
